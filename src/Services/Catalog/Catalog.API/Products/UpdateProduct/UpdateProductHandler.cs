...
public record UpdateProductCommand(Guid Id, string Name, string Description, string ImageFile, decimal Price, List<string> Category, int Count, bool IsAvailable) : ICommand<UpdateProductResult>;
